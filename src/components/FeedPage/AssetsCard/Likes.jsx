...
const Likes = ({ likes, id, setUpdateData, updateData }) => {
  ...
  return (
    <button className='flex gap-2 items-center' onClick={handleLike}>
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className={`w-5 h-5 ${iconColor} hover:fill-gray-500 hover:stroke-gray-500`}>
