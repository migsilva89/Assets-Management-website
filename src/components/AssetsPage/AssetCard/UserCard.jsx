...
const UserCard = () => {
  ...
  const { avatar, nickName, name } = userData
  ...
  return (
    <div className='w-full max-w-sm bg-white border border-gray-200 rounded-tr-lg shadow dark:bg-gray-800 dark:border-gray-700'>
      ...
      <div className='flex flex-col items-center pb-10'>
        <img className='w-24 h-24 mb-3 rounded-full shadow-lg' src={avatar === 'no-photo.jpg' ? 'https://static.vecteezy.com/system/resources/thumbnails/002/002/427/small_2x/man-avatar-character-isolated-icon-free-vector.jpg' : `http://localhost:5000/images/usersAvatar/${avatar}`} alt={`${nickName}'s avatar`}/>
